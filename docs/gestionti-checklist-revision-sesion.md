...
- [ ] Confirmar en **producción** que la misma asignación quedó aplicada (el usuario ya confirmó por captura en la sesión anterior; no se volvió a revisar en vivo esta vez).
