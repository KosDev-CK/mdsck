        ...
        <form wire:submit="verifyWithRecoveryCode" class="space-y-4">
            <div>
                ...
                <input
                    ...
                    id="recoveryCode"
                    autofocus
                    class="mt-1 block w-full text-center tracking-widest font-mono uppercase rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
