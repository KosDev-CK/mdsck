...
return [
    ...
    'campos' => [
        ...
        ['nombre' => 'Adjuntar responsiva firmada (en el listado)', 'explicacion' => 'Solo visible en asignaciones que todavía no tienen un documento firmado registrado. Abre un modal para subir el escaneo o vincular uno de SharePoint.'],
        ['nombre' => 'Ver responsiva / Quitar (en el listado)', 'explicacion' => 'Cuando ya hay un documento firmado registrado, "Ver responsiva" lo abre en una pestaña nueva y "Quitar" corrige un error de captura (técnico equivocado de archivo): desvincula el documento de la asignación sin borrar el archivo real de SharePoint/disco, y la opción "Adjuntar responsiva firmada" vuelve a aparecer para subir/vincular el correcto.'],
