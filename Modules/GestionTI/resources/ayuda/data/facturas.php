...
return [
    ...
    'proceso' => [
        ...
        'Si tienes la factura digitalizada a la mano, adjunta el PDF y/o el XML (CFDI) — son adjuntos independientes, puedes subir uno, otro, ambos, o ninguno por ahora y completarlo después editando el registro.',
    ...
    'campos' => [
        ...
        ['nombre' => 'Factura (PDF)', 'explicacion' => 'La factura digitalizada en PDF o imagen (máximo 5 MB). Opcional, independiente del XML. Desde el listado o el formulario de edición puedes "Ver PDF" o "Quitar" el actual (quitar solo desvincula el archivo del registro, nunca lo borra de donde esté guardado) para volver a adjuntar el correcto.'],
        ['nombre' => 'Factura (XML/CFDI)', 'explicacion' => 'El comprobante fiscal digital en XML (máximo 5 MB). Opcional, independiente del PDF. Si el archivo se guardó en este servidor, "Ver XML" abre una vista con los datos clave del CFDI (folio fiscal/UUID, fecha, total, emisor y receptor) además del XML completo; "Quitar" funciona igual que en el PDF.'],
