<div>
    ...
    <x-ui.card padding="p-5">
        ...
        <x-ui.table :headers="['Número de empleado', 'Nombre', 'Correo', 'Puesto', 'Estatus', '']" :empty="$records->isEmpty()" empty-description="Agrega el primero con el botón Nuevo.">
            @foreach ($records as $record)
                <tr wire:key="empleado-{{ $record->id }}" class="border-b border-gray-50 hover:bg-gray-50 dark:border-gray-800 dark:hover:bg-gray-800/50 transition-colors">
    ...
    <x-ui.help-modal titulo="Empleados" :pdf-url="route('gestionti.ayuda.pdf', 'catalogos-empleados')">
        @include('gestionti::ayuda.contenido', ['contenido' => \Modules\GestionTI\Support\Ayuda\AyudaCatalog::contenido('catalogos-empleados')])
    </x-ui.help-modal>
</div>
