 ...
 * registra en el log, en `EbsSyncFailure` (ver
 * `gestionti:ebs-reintentar-fallidos`) y el comando termina en FAILURE sin
 * excepción sin capturar — nunca debe afectar el flujo manual existente.
 */
class EbsSincronizarCreadasCommand extends Command
{
    ...
    public function handle(EbsRequisitionSyncService $service): int
    {
        ...
        try {
            ...
            EbsSyncFailure::registrar($fecha, EbsRequisitionsClient::METHOD_CREADAS, $errorCode, $errorMsg);
