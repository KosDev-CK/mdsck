...
namespace Modules\MesaServicio\Support\Ayuda;
 ...
 * descargable (`Modules\MesaServicio\Http\Controllers\Ayuda\AyudaPdfController`,
...
class AyudaCatalog
{
    ...
    {
        return module_path('MesaServicio', "resources/ayuda/data/{$slug}.php");
    }
}
