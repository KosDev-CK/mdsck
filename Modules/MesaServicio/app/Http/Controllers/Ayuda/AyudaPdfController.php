...
namespace Modules\MesaServicio\Http\Controllers\Ayuda;

use Barryvdh\DomPDF\Facade\Pdf;
use Illuminate\Routing\Controller;
use Modules\MesaServicio\Support\Ayuda\AyudaCatalog;
...
class AyudaPdfController extends Controller
{
    public function __invoke(string $slug)
    {
        ...
        return Pdf::loadView('mesaservicio::pdf.ayuda', [
     ...
     * diseño real), guardadas en Modules/MesaServicio/resources/assets/ayuda/.
     */
    private function imagenDataUri(string $filename): string
    {
        $path = module_path('MesaServicio', "resources/assets/ayuda/{$filename}");
