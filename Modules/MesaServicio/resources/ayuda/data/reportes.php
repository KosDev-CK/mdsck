...
return [
    ...
    'campos' => [
        ...
        ['nombre' => 'Tipo', 'explicacion' => '"Diario" o "Mensual" — el cierre mensual además incluye la métrica estimada de tickets combinados (folios que ServiceDesk Plus retira del listado al fusionar tickets).'],
